<x-app-layout>
    ...
    <div class="py-6 max-w-5xl mx-auto">
        <a href="{{ route('calon.create') }}" 
           class="bg-blue-500 text-white px-4 py-2 rounded">Tambah Data</a>

        <table class="table-auto w-full mt-4 border">
            <thead>
                <tr class="bg-gray-100">
                    <th class="px-4 py-2 border">Foto</th> <!-- ✅ Tambah kolom foto -->
                ...
                @foreach($calons as $calon)
                    <tr>
                        ...
                        <td class="px-4 py-2 border">
                            ...
                            <form action="{{ route('calon.destroy', $calon->id) }}" 
